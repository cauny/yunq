...
public class CustomTokenSubject implements Subject {
    ...
    public static Builder builder(com.usthe.sureness.subject.Subject subject) {
    ...
    public static class Builder {
        ...
        @SuppressWarnings("unchecked")
        public Builder(com.usthe.sureness.subject.Subject subject) {
